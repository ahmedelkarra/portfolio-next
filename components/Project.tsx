...
function Project({ item }: { item: IProjects }) {
    return (
        <article
            key={item?._id}
        ...
        >
            ...
            <div className="col-span-12 row-span-7 md:row-span-5 bg-white p-4 !pt-14 sm:p-6 rounded-b-xl">
                ...
                <div className="mt-4 flex flex-wrap gap-1">
                    {item?.using.map((ele, index) => {
                        return (
                            <span
                                key={index}
                                className="whitespace-nowrap rounded-full bg-orange-500 px-2.5 py-0.5 text-xs text-white"
                            >
                                {ele}
                            </span>
                        )
                ...
                <div className='my-4 flex gap-4'>
                    <a href={item?.website} target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='w-[25px] h-[25px]'>
                    ...
                    <a href={item?.github} target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className='w-[25px] h-[25px]'>
